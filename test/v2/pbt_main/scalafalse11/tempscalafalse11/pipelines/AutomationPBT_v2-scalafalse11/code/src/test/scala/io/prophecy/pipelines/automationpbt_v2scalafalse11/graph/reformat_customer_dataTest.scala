...
class reformat_customer_dataTest extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test ") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/automationpbt_v2scalafalse11/graph/reformat_customer_data/in/schema.json",
      "/data/io/prophecy/pipelines/automationpbt_v2scalafalse11/graph/reformat_customer_data/in/data/unit_test_.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/automationpbt_v2scalafalse11/graph/reformat_customer_data/out/schema.json",
      "/data/io/prophecy/pipelines/automationpbt_v2scalafalse11/graph/reformat_customer_data/out/data/unit_test_.json",
      "out"
    )

    val dfOutComputed = io.prophecy.pipelines.automationpbt_v2scalafalse11.graph
