package io.prophecy.pipelines.automationpbtno_v2scalafalse11

import io.prophecy.libs._
import io.prophecy.pipelines.automationpbtno_v2scalafalse11.config._
...
import io.prophecy.pipelines.automationpbtno_v2scalafalse11.graph._
...
object Main {
  ...
  def apply(context: Context): Unit = {
    ...
    val df_execute_script = execute_script(context, df_reformat_customer_data)
  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/AutomationPBTNo_v2-scalafalse11"
    )
    registerUDFs(spark)
